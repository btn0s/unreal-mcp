...
private:
    ...
    TSharedPtr<FJsonObject> HandleGetCurrentLevelInfo(const TSharedPtr<FJsonObject>& Params);

    // Python execution command
    TSharedPtr<FJsonObject> HandleExecEditorPython(const TSharedPtr<FJsonObject>& Params);
}; 